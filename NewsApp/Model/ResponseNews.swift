...
struct ResultNews: Codable {
    ...
    let nytdsection, adxKeyowrds: String
    let column: String?
    let byline: String
    let type: ResultNewsType
...
struct Media: Codable {
    ...
    let mediaMetaData: [MediaMetadatatum]
...
struct MediaMetadatatum: Codable {
    let url: String
    let format: Format
...
enum ResultNewsType: String, Codable {
